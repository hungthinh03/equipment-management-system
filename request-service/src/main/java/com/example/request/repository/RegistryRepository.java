...
import com.example.request.dto.RegistryDTO;
...
public interface RegistryRepository extends ReactiveCrudRepository<Registry, Integer> {
    ...
    Flux<RegistryDTO> findAllRegistryByRequesterId(Integer requesterId);
    ...
    Mono<RegistryDTO> findByRequestId(Integer requestId);
}
